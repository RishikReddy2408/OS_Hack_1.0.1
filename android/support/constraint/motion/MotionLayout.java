  ...
  implements NestedScrollingParent2
{
  ...
  static final String PAGE_KEY = "MotionLayout";
  ...
  {
    int i = mLastWidthMeasureSpecOnLayout;
    int j = mLastHeightMeasureSpecOnLayout;
    try
    {
      super.onMeasure(i, j);
      mInTransition = true;
      ...
      while (i < j)
      {
        ...
        localObject = ((HashMap)localObject).get(localView);
        localObject = (MotionController)localObject;
        if (localObject != null) {
          ((MotionController)localObject).setEndState(getViewWidget(localView), paramConstraintSet);
        }
        i += 1;
      }
      return;
  ...
  private void computeStartPositions(ConstraintSet paramConstraintSet)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ...
        localObject = (MotionController)localObject;
        if (localObject != null) {
          ((MotionController)localObject).setStartState(getViewWidget(localView), paramConstraintSet);
        }
        i += 1;
      }
      return;
      ...
      if (mInterpolator != null)
      {
        ...
        if (i == 0) {
          if (mTemporalInterpolator)
          {
            ...
            f2 = mInterpolator.getInterpolation(f1 * 1.0E-9F);
            f1 = f2;
            mTransitionLastPosition = f2;
            mTransitionLastTime = l;
          }
  ...
  public void loadLayoutDescription(int paramInt)
  {
    if (paramInt != 0) {
      try
      {
        MotionScene localMotionScene = new MotionScene(getContext(), this, paramInt);
        mScene = localMotionScene;
        return;
      }
  ...
  private class DevModeDraw
  {
    ...
    private void drawRectangle(Canvas paramCanvas, MotionController paramMotionController)
    {
      ...
      while (i <= 50)
      {
        paramMotionController.buildRect(i / 50.0F, mRectangle, 0);
    ...
    public void draw(Canvas paramCanvas, HashMap paramHashMap, int paramInt1, int paramInt2)
    {
      if (paramHashMap != null)
      {
        ...
        while (paramHashMap.hasNext())
        {
          ...
          int k = localMotionController.getDrawPath();
          int j = k;
          int i = j;
          if (paramInt2 > 0)
          {
