...
public final class MediaControllerCompat
{
      ...
      extends Handler
    {
      ...
      public void handleMessage(Message paramMessage)
      {
        ...
        case 11: 
          ...
          return;
        case 10: 
          onShuffleModeChanged(((Boolean)obj).booleanValue());
          return;
        case 9: 
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    private void processPendingCallbacks()
    {
      ...
      List localList = mPendingCallbacks;
      try
      {
        Iterator localIterator = mPendingCallbacks.iterator();
        while (localIterator.hasNext())
        {
          Object localObject = (MediaControllerCompat.Callback)localIterator.next();
          ExtraCallback localExtraCallback = new ExtraCallback((MediaControllerCompat.Callback)localObject);
          mCallbackMap.put(localObject, localExtraCallback);
          mHasExtraCallback = true;
          localObject = mExtraBinder;
          try
          {
            ((IMediaSession)localObject).registerCallbackListener(localExtraCallback);
          }
    ...
    public PlaybackStateCompat getPlaybackState()
    {
      if (mExtraBinder != null)
      {
        Object localObject1 = mExtraBinder;
        try
        {
    ...
    public final void registerCallback(MediaControllerCompat.Callback paramCallback, Handler paramHandler)
    {
      ...
      if (mExtraBinder != null)
      {
        ...
        mHasExtraCallback = true;
        paramCallback = mExtraBinder;
        try
        {
          paramCallback.registerCallbackListener(paramHandler);
          return;
        }
      ...
      paramHandler = mPendingCallbacks;
      try
      {
    ...
    public final void unregisterCallback(MediaControllerCompat.Callback paramCallback)
    {
      ...
      if (mExtraBinder != null)
      {
        localObject = mCallbackMap;
        try
        {
          paramCallback = ((HashMap)localObject).remove(paramCallback);
          paramCallback = (ExtraCallback)paramCallback;
          if (paramCallback == null) {
            return;
          }
          localObject = mExtraBinder;
          ((IMediaSession)localObject).unregisterCallbackListener(paramCallback);
          return;
        }
        catch (RemoteException paramCallback)
        {
    ...
    public void registerCallback(MediaControllerCompat.Callback paramCallback, Handler paramHandler)
    {
      if (paramCallback != null)
      {
        ...
        try
        {
          ...
          paramHandler = mBinder;
          Object localObject = mCallbackObj;
          localObject = (IMediaControllerCallback)localObject;
          paramHandler.registerCallbackListener((IMediaControllerCallback)localObject);
          return;
        }
    ...
    public void unregisterCallback(MediaControllerCompat.Callback paramCallback)
    {
      if (paramCallback != null)
      {
        ...
        try
        {
          Object localObject = mCallbackObj;
          localObject = (IMediaControllerCallback)localObject;
          localIMediaSession.unregisterCallbackListener((IMediaControllerCallback)localObject);
          localIMediaSession = mBinder;
    ...
    extends MediaControllerCompat.TransportControls
  {
    ...
    public void setShuffleModeEnabled(boolean paramBoolean)
    {
      ...
      try
      {
        localIMediaSession.setShuffleModeEnabledDeprecated(paramBoolean);
        return;
      }
      catch (RemoteException localRemoteException)
      {
