    ...
    void removeMessages(int paramInt)
    {
      try
      {
        ...
        if (mRoot != null)
        {
          ...
          for (localObject1 = MessageThreadUtil.SyncQueueItem.access$000((MessageThreadUtil.SyncQueueItem)localObject2); localObject1 != null; localObject1 = localSyncQueueItem)
          {
            localSyncQueueItem = MessageThreadUtil.SyncQueueItem.access$000((MessageThreadUtil.SyncQueueItem)localObject1);
            if (what == paramInt)
            {
              MessageThreadUtil.SyncQueueItem.access$002((MessageThreadUtil.SyncQueueItem)localObject2, localSyncQueueItem);
              ((MessageThreadUtil.SyncQueueItem)localObject1).recycle();
            }
            else
            {
