...
{
  private HashSet<com.google.android.gms.common.data.DataBufferObserver> zall = new HashSet();
  
  public DataBufferObserverSet() {}
  
  public final void addObserver(DataBufferObserver paramDataBufferObserver)
  {
    zall.add(paramDataBufferObserver);
  }
  ...
  {
    Iterator localIterator = zall.iterator();
  ...
  {
    zall.remove(paramDataBufferObserver);
  }
}
